    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addmem_bt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent add_mem = new Intent(MainActivity.this, AddMember.class);
        ...
        String[] from = new String[] { DBhelper.MEMBER_ID, DBhelper.NOTE_TITLE, DBhelper.NOTE_DESCRITION,DBhelper.NOTE_DATE };
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                memName_tv = (TextView) view.findViewById(R.id.note_title);
                ...
                Intent modify_intent = new Intent(getApplicationContext(),
                        ModifyMember.class);
                modify_intent.putExtra("title", memberName_val);
                modify_intent.putExtra("description", memberName_val);
                modify_intent.putExtra("date", memberName_val);
